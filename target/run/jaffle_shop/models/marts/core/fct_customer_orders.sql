        ...
        create or replace transient table dbt.dbt_swiesner.fct_customer_orders  as
        (with 

orders as (

  select * from dbt.dbt_swiesner.int_orders

),

customers as (

  select * from dbt.dbt_swiesner.stg_jaffle_shop__customers
